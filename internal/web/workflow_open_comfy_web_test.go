...
func TestOpenComfyControlIsAFormThatOpensANewTab(t *testing.T) {
	...
	got := renderString(t, workflowDetailPage(uiWF, "{}", "csrf", "dark", "blur", nil, true, comfyHelperView{}, workflowResolver{}))
...
func TestOpenComfyNeverEmitsWorkflowParam(t *testing.T) {
	...
	variants := map[string]func(t *testing.T) string{
		...
		"detail page": func(t *testing.T) string {
			...
			return renderString(t, workflowDetailPage(wf, "{}", "csrf", "dark", "blur", nil, true, comfyHelperView{}, workflowResolver{}))
		},
	}
...
func TestWorkflowDetailOpenComfyButtonGating(t *testing.T) {
	...
	gotAPI := renderString(t, workflowDetailPage(apiWF, "{}", "csrf", "dark", "blur", nil, true, comfyHelperView{}, workflowResolver{}))
	...
	gotNoComfy := renderString(t, workflowDetailPage(uiWF, "{}", "csrf", "dark", "blur", nil, false, comfyHelperView{}, workflowResolver{}))
...
func TestComfyHelperDisclosureIsTheManagementSurface(t *testing.T) {
	...
	t.Run("not installed: status + install only", func(t *testing.T) {
		...
		got := renderString(t, workflowDetailPage(uiWF, "{}", "csrf", "dark", "blur", nil, true, hv, workflowResolver{}))
