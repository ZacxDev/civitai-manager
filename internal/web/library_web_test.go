...
func TestLibraryAndTrashPagesRender(t *testing.T) {
	...
	out := renderString(t, libraryPage(buildLibraryView(files), "csrf-tok", true, []string{"/data/models"}, "dark", "files", nil, false, nil, NSFWBlur, libraryWorkflowsView{}))
...
func TestScanFormRendersPathsInput(t *testing.T) {
	...
	sources := renderString(t, libraryPage(buildLibraryView(nil), "csrf-tok", true, nil, "dark", "sources", nil, false, nil, NSFWBlur, libraryWorkflowsView{}))
	for _, want := range []string{
	...
	files := renderString(t, libraryPage(buildLibraryView(nil), "csrf-tok", true, []string{"/data/x"}, "dark", "files", nil, false, nil, NSFWBlur, libraryWorkflowsView{}))
...
func TestScanFormRendersPersistedSelection(t *testing.T) {
	out := renderString(t, libraryPage(buildLibraryView(nil), "csrf-tok", true, []string{"/data/loras"}, "dark", "sources", nil, false, nil, NSFWBlur, libraryWorkflowsView{}))
...
func TestScanFormOmitsPathsInputWhenNotAllowed(t *testing.T) {
	...
	sources := renderString(t, libraryPage(buildLibraryView(nil), "csrf-tok", false, nil, "dark", "sources", nil, false, nil, NSFWBlur, libraryWorkflowsView{}))
...
func TestFilesTabGatedOnAddedDir(t *testing.T) {
	for _, allowExtra := range []bool{true, false} {
		...
		withDir := renderString(t, libraryPage(buildLibraryView(nil), "csrf", allowExtra, []string{"/some/install/dir"}, "dark", "files", nil, false, nil, NSFWBlur, libraryWorkflowsView{}))
