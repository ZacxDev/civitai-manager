...
func TestDefaultTabIsInstallDirectories(t *testing.T) {
	out := renderString(t, libraryPage(buildLibraryView(nil), "csrf", true, nil, "dark", "", nil, false, nil, NSFWBlur))
...
func TestFilesTabEmptyStateWhenNoDirs(t *testing.T) {
	out := renderString(t, libraryPage(buildLibraryView(nil), "csrf", true, nil, "dark", "files", nil, false, nil, NSFWBlur))
